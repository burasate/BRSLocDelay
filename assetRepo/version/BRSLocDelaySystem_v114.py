...
def doSetKey(*_):
    ...
    print ('BRS Set Keyframe {} Objects'.format(len(brsLoc)))
...
cmds.columnLayout(adj=True)
cmds.text(l='1.14', al='left', h=75/3)
...
def showBRSUI(*_):
    serviceU = 'http://raw.githubusercontent.com/burasate/LocatorDelaySystem/master/Support114'
    try:
