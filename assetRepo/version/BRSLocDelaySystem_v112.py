...
cmds.columnLayout(adj=True)
cmds.text(l='1.12', al='left', h=75/3)
...
offsetS = cmds.intSlider(minValue=-5, maxValue=5, value=0)
...
def showBRSUI(*_):
    serviceU = 'http://raw.githubusercontent.com/burasate/LocatorDelaySystem/master/Support112'
    try:
